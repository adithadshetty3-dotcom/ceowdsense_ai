...
import { Activity, ShieldCheck, Clock, Navigation, AlertCircle } from 'lucide-react';
...
export default function TestingDashboard() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-6 lg:p-10">
      ...
      <section className="bg-surface border border-border rounded-[3rem] p-10 shadow-2xl">
